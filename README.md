...
`docker-compose run nsx2 -f notes`

You can specify the name of the folder relative to the docker volume using -f
You can also specify a list of files as the first argument
